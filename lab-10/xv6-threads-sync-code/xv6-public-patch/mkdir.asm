...
main(int argc, char *argv[])
{
  ...
  4d:	50                   	push   %eax
  4e:	e8 38 03 00 00       	call   38b <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 485:	0f b6 91 60 0c 00 00 	movzbl 0xc60(%ecx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5be:	75 25                	jne    5e5 <printf+0xff>
          s = "(null)";
 5c0:	c7 45 f4 cf 08 00 00 	movl   $0x8cf,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 686:	a1 7c 0c 00 00       	mov    0xc7c,%eax
 ...
 751:	a3 7c 0c 00 00       	mov    %eax,0xc7c
}
 756:	90                   	nop
 757:	c9                   	leave  
 758:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7af:	83 c4 10             	add    $0x10,%esp
  return freep;
 7b2:	a1 7c 0c 00 00       	mov    0xc7c,%eax
}
 7b7:	c9                   	leave  
 7b8:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7cb:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7ce:	a1 7c 0c 00 00       	mov    0xc7c,%eax
 7d3:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7d6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7da:	75 23                	jne    7ff <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7dc:	c7 45 f0 74 0c 00 00 	movl   $0xc74,-0x10(%ebp)
 7e3:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7e6:	a3 7c 0c 00 00       	mov    %eax,0xc7c
 7eb:	a1 7c 0c 00 00       	mov    0xc7c,%eax
 7f0:	a3 74 0c 00 00       	mov    %eax,0xc74
    base.s.size = 0;
 7f5:	c7 05 78 0c 00 00 00 	movl   $0x0,0xc78
 7fc:	00 00 00 
  }
 ...
 852:	a3 7c 0c 00 00       	mov    %eax,0xc7c
      return (void*)(p + 1);
 ...
 85d:	eb 3b                	jmp    89a <malloc+0xe1>
    ...
    if(p == freep)
 85f:	a1 7c 0c 00 00       	mov    0xc7c,%eax
